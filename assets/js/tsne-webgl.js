...
var imageData = {};
var imageDataKeys = [];
selectedBrands = 'samsung|apple|lgco|nokia|huawei|pixel';
...
function loadData() {
  get('brand_counts.json', function(data) {
    ...
    brandCounts = [
    {x: "samsung", value: brandCountsHolder["samsung"]},
    {x: "apple", value: brandCountsHolder["apple"]},
    {x: "lgco", value: brandCountsHolder["lgco"]},
    {x: "nokia", value: brandCountsHolder["nokia"]},
    {x: "huawei", value: brandCountsHolder["huawei"]},
    {x: "pixel", value: brandCountsHolder["pixel"]}
];
  })    
...
function addWindowEventListeners() {
  ...
  window.addEventListener('hashchange', function(e) {
    ...
    marker.XPos = (((coords.x + 9160)/(9540 + 9160)) * 300) - (marker.Width / 2);
    marker.YPos = (193 - ((coords.y + 9920)/(8608 + 9920)) * 193) - marker.Height;
    ...
    clusterCounts = [
    {x: "samsung", value: thisClusterData["samsung"]},
    {x: "apple", value: thisClusterData["apple"]},
    {x: "lgco", value: thisClusterData["lgco"]},
    {x: "nokia", value: thisClusterData["nokia"]},
    {x: "huawei", value: thisClusterData["huawei"]},
    {x: "pixel", value: thisClusterData["pixel"]}
    ]
...
mapSprite.src = "assets/images/Samsung Phone Full Map.png";
